...
\end{center}
\label{chap:01}
\addcontentsline{toc}{section}{\protect\textbf{CHAPTER I. INTRODUCTION}}
\section{Overview}
...
\end{center}
\label{chap:02}
\addcontentsline{toc}{section}{\protect\textbf{CHAPTER II. THEORETICAL PRELIMINARIES}}
...
\end{spacing}
\label{chap:03}
\addcontentsline{toc}{section}{\protect\textbf{CHAPTER III. BUILDING AN VIETNAMESE OPEN-DOMAIN QUESTION ANSWERING SYSTEM FOR COVID-19 TOPIC}}
\setcounter{section}{0}
...
\addcontentsline{toc}{section}{\protect\textbf{CHAPTER IV. EXPERIMENTAL RESULTS}}
\setcounter{section}{0}
\section{Datasets}
